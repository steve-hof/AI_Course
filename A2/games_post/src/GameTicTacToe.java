...
public class GameTicTacToe extends Game {
    ...
    public GameTicTacToe() {
    	setCurrentState(new StateTicTacToe());
    }
        ...
        while (true) {
            ...
            switch ( game.getCurrentState().player ) {
              case 1: //Human
                  ...
                  nextState = new StateTicTacToe((StateTicTacToe) game.getCurrentState());
                  nextState.player = 1;
            ...
            if ( game.isWinState(game.getCurrentState()) ) {
            	...
            	if (game.getCurrentState().player == 1) //i.e. last move was by the computer
